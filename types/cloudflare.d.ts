...
declare module 'cloudflare:workers' {export const env:{DB:D1Database;AUTH_MODE?:string;OWNER_ID?:string;COACH_KEY_HASH?:string;LOGIN_KEY_HASH?:string;SESSION_SECRET?:string;OPENROUTER_API_KEY?:string;OPENROUTER_MODEL?:string;ASSETS?:Fetcher};}
